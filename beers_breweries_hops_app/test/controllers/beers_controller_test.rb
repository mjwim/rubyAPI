...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { ABV: @beer.ABV, artwork: @beer.artwork, brewery_id: @beer.brewery_id, description: @beer.description, name: @beer.name } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { ABV: @beer.ABV, artwork: @beer.artwork, brewery_id: @beer.brewery_id, description: @beer.description, name: @beer.name } }, as: :json
    assert_response 200
  end
